...
// $config['mongo_db']['default']['hostname'] = '198.168.1.88';
// $config['mongo_db']['default']['port'] = '27017';
// $config['mongo_db']['default']['username'] = 'mongolocal';
// $config['mongo_db']['default']['password'] = 'ndot1234';
// $config['mongo_db']['default']['database'] = 'student_data';
...
$mongo['host'] = '192.168.1.88';
$mongo['port'] = '27017';
$mongo['dbname'] = 'student_data';
$mongo['user'] = 'root';
$mongo['password'] = 'ndot';
$mongo['connString'] = "mongodb://192.168.1.88:27017"; // if you need to custom connection string, just set this. Exp. mongodb://localhost:27017
$config['mongo'] = $mongo;
